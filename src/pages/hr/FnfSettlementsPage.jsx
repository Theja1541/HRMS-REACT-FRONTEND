...
import { FNF_SETTLEMENT_STATUSES, FNF_SETTLEMENT_STATUS_LABELS } from '../../constants/hr';
...
export default function FnfSettlementsPage() {
  ...
  const counts = useMemo(() => {
    const c = { draft: 0, calculated: 0, approved: 0, partially_paid: 0, paid: 0 };
    allSettlements.forEach((s) => { if (c[s.status] !== undefined) c[s.status]++; });
    return c;
  }, [allSettlements]);
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Full & final settlement queue — track, approve and pay out"
      />
