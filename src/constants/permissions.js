...
export const ROLE_HIERARCHY = [
  ...
  { role: 'auditor', label: 'Auditor', description: 'Read-only Day Book dashboard and transactions' },
];
...
const MODULE_ACCESS = {
  ...
  auditor: 'Day Book dashboard and transactions (read-only; direct URLs blocked elsewhere)',
};
