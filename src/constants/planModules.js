export const PLAN_MODULES = [
  ...
  },
  {
    ...
    label: 'Day Book',
    icon: 'BookOpen',
    description: 'Daily financial ledger entries.',
  ...
  },
  {
    ...
    pages: [{ key: 'summary', label: 'Summary' }],
  },
  {
    key: 'gst',
    label: 'GST Monthly',
    icon: 'Receipt',
    description: 'GST filing and monthly returns.',
    pages: [{ key: 'returns', label: 'GST Returns' }],
  },
  {
    key: 'pf_summary',
